...
%now we are going to define all above equation as a function by matlabfunction keyword. 
...
for i=1:n
R=[f11(x(1), x(2), x(3));f22(x(1), x(2), x(3));f33(x(1), x(2), x(3))];
...
y=-J\R;  %  / <-----is inverse of J
if norm(y)<e
         fprintf('solution found within %d iteration\n', i) 
break
end
